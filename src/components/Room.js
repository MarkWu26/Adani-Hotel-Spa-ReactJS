...
const Room = ({room}) => {
  ...
  <div className='bg-white shadow-2xl min-h-[500px] group'>
    ...
    <div className='bg-white shadow-lg max-w-[300px] h-[60px] mx-auto -translate-y-1/2 flex justify-center uppercase items-center font-tertiary tacking-[1px] font-semibold text-[16px] text-base'>
